...
const emit = defineEmits(["closeEditSubLecture"]);

const closeEditSubLecture = () => {
    emit("closeEditSubLecture");
};
    ...
    <div class="flex justify-center items-center w-full h-full absolute top-0">
        <div class="w-[90%] h-[92vh] bg-(--md-sys-color-surface) rounded-[12px] border border-(--md-sys-color-outline-variant) p-4 overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
                ...
                <md-icon-button @click="closeEditSubLecture">
            ...
            <div v-else class="flex flex-col gap-8 justify-center items-center py-4">
                ...
                <div v-if="error" class="w-200 p-4 bg-red-100 text-red-700 rounded-md">
                    {{ error }}
                </div>
                
                <div class="flex gap-4 mt-8 w-200">
                    <md-filled-button class="flex-1" @click="handleEditSubLecture" :disabled="!isFormValid">
                        Save Changes
                    </md-filled-button>
                    <md-outlined-button class="flex-1" @click="closeEditSubLecture">
                        Cancel
                    </md-outlined-button>
                </div>
            </div>
